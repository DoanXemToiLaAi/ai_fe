    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          >
            Tải lên hình ảnh sản phẩm và để AI phân loại tự động. Công nghệ của chúng tôi sẽ nhận diện và phân loại sản
            phẩm chính xác.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="mb-6 text-gray-600">Hỗ trợ các định dạng JPG, PNG và GIF. Kích thước tối đa 10MB.</p>
            ...
            {isLoading ? (
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
                ...
                <div className="p-6 bg-blue-50 rounded-lg mb-6">
                  <h3 className="font-medium text-blue-800 mb-2">Kết quả phân loại</h3>
                  <p className="text-2xl font-bold text-blue-600 mb-2">{result.category}</p>
                  <p className="text-sm text-blue-600">Độ chính xác: {result.confidence || 95}%</p>
                </div>

                <div className="mt-6">
                  <Link href={`/categories/${result.category}`}>
                    <Button className="w-full bg-blue-600 hover:bg-blue-700">
                      <ShoppingBag className="mr-2 h-5 w-5" /> Xem sản phẩm tương tự
                    </Button>
                  </Link>
                </div>
              </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Tải lên hình ảnh sản phẩm bạn muốn phân loại</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mb-4">
                2
              ...
              <p className="text-gray-600">Hệ thống AI của chúng tôi phân tích và nhận diện sản phẩm</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mb-4">
                3
              ...
              <p className="text-gray-600">Nhận kết quả phân loại và xem các sản phẩm tương tự</p>
            </div>
          </div>
        </motion.div>
      </div>
