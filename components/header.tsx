        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/upload" className="text-gray-600 hover:text-primary">
              ...
              <span className="px-3 py-1 text-sm border border-primary text-primary rounded-md">AI Classify</span>
            </Link>
            <Link href="/recommendations/user123" className="text-gray-600 hover:text-primary">
              <span className="sr-only">Recommendations</span>
              <span className="px-3 py-1 text-sm bg-primary text-white rounded-md">For You</span>
            </Link>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-4">
              ...
              <Link href="/deals" className="block py-2 text-gray-700 hover:text-blue-600 transition-colors">
                Khuyến mãi
              </Link>
